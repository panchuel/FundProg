...
namespace Calculo_de_deducciones_salariales
{
    class Program
    {
        static void Main()
        {
            ...
            int tipo_contraro = int.Parse(Console.ReadLine());
                ...
                //Proceso
                    if(tipo_contraro == 1)
                    {
                        ...
                        salario_real_menusal = salario_mensual - deducciones;
                        Console.WriteLine("Su salario real mensual es: " + salario_real_menusal);
                        salario_anual = salario_real_menusal * 12 + salario_mensual;
                        Console.WriteLine("Su salario anual es. " + salario_anual);
                    }
                    else if(tipo_contraro == 2)
                    {
                        ...
                        if(riesgo_laboral == 1)
                        {
                            ...
                            salario_real_menusal = salario_mensual - deducciones;
                            salario_anual = salario_real_menusal * 12;
                            Console.WriteLine("Su salario real mensual es: " + salario_real_menusal);
                            Console.WriteLine("Su salario anual es. " + salario_anual);
                        }
                        if(riesgo_laboral == 2)
